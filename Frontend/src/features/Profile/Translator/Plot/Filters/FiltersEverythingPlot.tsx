...
import useGetTranslationCommandsQueries from "../../../../../hooks/Fetching/Translation/PlotfieldCommands/useGetTranslationCommandsQueries";
...
export default function FiltersEverythingPlot({
  ...
  translateToLanguage,
}: FiltersEverythingCharacterForPlotTypes) {
                ...
                <DisplayTranslatedNonTranslatedPlotGetItem
                  ...
                  nonTranslated={
                    ...
                    memoizedCombinedMultipleCommandsTranslations.getItem
                      .nonTranslated[i]
                      ? memoizedCombinedMultipleCommandsTranslations.getItem
                          .nonTranslated[i].getItemGrouped
                      : null
                  }
                  languageToTranslate={translateToLanguage}
                  translatedLanguage={translateFromLanguage}
