...
import useGetTranslationCharacterEnabled from "../../../../Editor/PlotField/PlotFieldMain/Commands/hooks/Character/useGetTranslationCharacterEnabled";
...
export default function DisplayTranslatedNonTranslatedRecentCharacter({
  ...
  useEffect(() => {
    if (nonTranslatedCharacter) {
      nonTranslatedCharacter.map((nt) => {
